  ...
  render() {
    return (
      <div className="Card">
        <div
          id="square"
          className="bounceIn flipInY animated"
        ...
        >
          ...
          <div className="text">
            ...
            <div className="category category_bottom">
              {String(this.state.store.category)
                .replace("|", ", ")
                .replace("null", "")}
              &nbsp;
            </div>
              <div className="category"><Emoji label="search" symbol="⭐" />{this.state.store.avg_score}&nbsp;&nbsp;🌼{this.state.store.area?<>{this.state.store.area}</>:" - "}</div>
