    ...
    return (
      <div className="Box">
        ...
        <div className="About">
          ...
          {this.features.map((feature, index) => <div key={index}>{this.state.check ? (feature.id === "bigdata" && <Feature feature={feature}/>): (<Feature feature={feature}/>)}</div>)}
        </div>
        <AppBar></AppBar>
      </div>
    );
